...
creator = 'Dryan-MD' // Nama 
port = 8080 //port host
LimitApikey = 200 // Limit Apikey default

//___________ ┏  Database Mongodb Setting  ┓ ___________\\

keymongodb = "mongodb+srv://user:password@name_database.mongodb.net/?retryWrites=true&w=majority";
...
servicesmtp = 'GMAIL SMTP'//Ada gmail ada sendinblue ikut masing2 limit gmail 500 limit sendinblue 300 free. List service smtp : https://nodemailer.com/smtp/well-known/
sendemail = 'dryanbot24@gmail.com' //Email SMTP
fromsendemail = 'dryanbot24@gmail.com' // From Email SMTP *kalau takde custom email kena sama email dengan Email SMTP
sendpwmail = 'xpprynmscagtdayg' // Password Email SMTP
domain = 'api-dryan.my.id'// domain website tanpa http or https
...
recaptcha_key_1 = '6Lf0FOkkAAAAAKn7kUn7sltj7x-VHUCTsPknb_pk'
recaptcha_key_2 = '6Lf0FOkkAAAAAHDsk9XS4VvQybE5LEoFoT_Bd9dy'
